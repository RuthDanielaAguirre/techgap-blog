            ...
            <article class="bg-white rounded-xl shadow-sm border border-gray-200/60 overflow-hidden">
                ...
                <div class="px-5 pt-5">
                    <a href="{{ route('posts.category', $post->category->slug) }}"
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-techgap-100 text-techgap-800 hover:bg-techgap-200 transition">
                ...
                <div class="px-5 pt-4">
                    ...
                    <div class="flex flex-wrap gap-2 py-4">
                        ...
                        <a href="{{ route('posts.tag', $tag->slug) }}"
                            class="px-2.5 py-1 text-[11px] font-medium rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition">
                            #{{ $tag->name }}
                        </a>
                        @endforeach
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-8 pb-16 mt-10">
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <a href="{{ route('posts.show', $related->slug) }}"
                ...
                @if($related->category)
                    <div class="flex items-center text-sm font-medium mb-2 text-techgap-600">
                        @if($related->category->icon ?? false)
                ...
                <p class="text-[12px] text-gray-500 mt-2">
                    {{ $related->reading_time ?? '5 min' }} — {{ $related->user->name ?? 'Autor' }}
                </p>
            </a>
            @endforeach
        </div>
