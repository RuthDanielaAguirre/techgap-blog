...
<body class="antialiased bg-[#F0F4FA] text-[#1A2238]">
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-20">
        ...
        <div class="w-full max-w-md space-y-10">
            ...
            <div class="text-center">
                {{-- <div class="flex justify-center">
                    <div class="w-20 h-20 bg-[#1BBF9B] rounded-2xl flex items-center justify-center shadow-xl shadow-[#1BBF9B]/20">
                        <img src="{{ asset('images/logo.png') }}" alt="TechGap" class="w-14 h-14 object-contain">
                    </div>
                </div> --}}
                ...
                <h2 class="mt-6 text-3xl font-extrabold" style="color:#1A2238;">
                    Bienvenido de nuevo
                </h2>

                <p class="mt-2 text-sm" style="color:#2E3A59;">
                    ¿No tienes cuenta?
            ...
            <!-- Form Card -->
            <div class="bg-white border border-[#D5DCE5] rounded-2xl shadow-xl p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <!-- Email -->
                    <div>
                        <label for="email" class="block text-sm font-medium" style="color:#1A2238;">
                            Correo electrónico
                        </label>
                        ...
                        <div class="relative mt-2">
                            ...
                            <input 
                                ...
                                required 
                                value="{{ old('email') }}"
                                class="block w-full pl-10 pr-3 py-3 bg-[#E6EBF1] border border-[#D5DCE5] rounded-lg text-[#1A2238] placeholder-gray-500 focus:ring-2 focus:ring-[#1BBF9B] focus:border-transparent transition"
                    ...
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-sm font-medium" style="color:#1A2238;">
                            Contraseña
                        </label>
                        ...
                        <div class="relative mt-2" x-data="{ show: false }">
                            ...
                            <input 
                                ...
                                required
                                class="block w-full pl-10 pr-10 py-3 bg-[#E6EBF1] border border-[#D5DCE5] rounded-lg text-[#1A2238] placeholder-gray-500 focus:ring-2 focus:ring-[#1BBF9B] focus:border-transparent transition"
                                placeholder="••••••••"
                            >
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center space-x-2" style="color:#2E3A59;">
                            <input 
                                id="remember" 
                                name="remember" 
                                type="checkbox"
                                class="h-4 w-4 text-[#1BBF9B] focus:ring-[#1BBF9B] border-[#D5DCE5] bg-[#E6EBF1] rounded"
                            >
