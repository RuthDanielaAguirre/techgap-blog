...
<body class="antialiased">
    ...
    <div class="absolute inset-0 w-full h-full">
        ...
        {{-- Imagen tech oscura (similar a UI8) --}}
        <img 
            src="https://images.unsplash.com/photo-1657036155353-6f15249d9ddb?q=80&w=1373&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    ...
    <div class="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8">
                ...
                {{-- Registro --}}
                <p class="text-center text-gray-300 text-sm my-6">
                    ¿No tienes cuenta?
                    <a href="{{ route('register') }}" class="text-[#1BBF9B] hover:text-[#17A988] font-semibold">
                        Regístrate gratis
                    </a>
                </p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required 
                                value="{{ old('email') }}"
                                class="block w-full px-4 pl-10 pr-3 py-3 rounded-lg bg-white/15 border border-white/30 text-white placeholder-gray-300 focus:ring-2 focus:ring-[#1BBF9B] focus:border-transparent transition"
                        ...
                        <div class="relative" x-data="{ show: false }">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                             ...
                             <input 
                                ...
                                required
                                class="block w-full pl-10 pr-10 py-3 rounded-lg bg-white/15 border border-white/30 text-white placeholder-gray-300 focus:ring-2 focus:ring-[#1BBF9B] focus:border-transparent transition"
                                placeholder="••••••••"
                            >
                    ...
                    <div class="flex items-center justify-between text-gray-300 text-sm">
                        <label class="flex items-center space-x-2">
                            <input 
                                type="checkbox"
                                class="h-4 w-4 text-[#1BBF9B] bg-transparent border-white/40 rounded"
                            >
                            <span>Recuérdame</span>
                        </label>

                        <a href="#" class="text-[#1BBF9B] hover:text-[#17A988] transition">
                    ...
                    <button 
                        ...
                        class="w-full py-3 px-4 rounded-lg font-semibold bg-[#1BBF9B] text-[#020617]
                               hover:bg-[#17A988] transition shadow-lg hover:shadow-xl"
                    >
                        Iniciar Sesión
                    </button>
