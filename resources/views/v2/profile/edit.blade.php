        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-linear-to-br from-techgap-500 to-techgap-700 rounded-xl flex items-center justify-center mr-4">
                ...
                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="w-24 h-24 rounded-2xl bg-linear-to-br from-techgap-400 to-techgap-600 flex items-center justify-center text-white font-bold text-3xl shadow-lg">
                                @if($user->avatar)
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-linear-to-br from-amber-500 to-orange-600 rounded-xl flex items-center justify-center mr-4">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 border-2 border-red-200">
                <div class="flex items-center mb-6">
                    <div class="w-12 h-12 bg-linear-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mr-4">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="deleteModal" class=" fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
