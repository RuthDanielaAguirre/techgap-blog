...
@section('content')
<div class="bg-linear-to-br from-gray-50 to-blue-50 min-h-screen py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header con Cover Image -->
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8 border border-gray-100">
            <!-- Cover Image -->
            <div class="h-48 bg-linear-to-br from-techgap-500 via-techgap-600 to-blue-600 relative">
            ...
            <div class="px-8 pb-8 -mt-20 relative">
                <div class="flex flex-col md:flex-row md:items-end md:space-x-6">
                    ...
                    <div class="relative mb-4 md:mb-0">
                        <div class="w-32 h-32 rounded-3xl bg-linear-to-br from-techgap-400 via-techgap-500 to-techgap-600 flex items-center justify-center text-white font-bold text-5xl shadow-2xl ring-8 ring-white">
                            @if($user->avatar)
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                            ...
                            <a href="{{ route('profile.edit') }}" 
                               class="mt-4 sm:mt-0 inline-flex items-center px-6 py-3 bg-linear-to-br from-techgap-600 to-techgap-700 text-white rounded-xl font-semibold hover:from-techgap-700 hover:to-techgap-800 transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    ...
                    <div class="space-y-4">
                        @if($user->isWriter() || $user->isAdmin())
                            <!-- Posts -->
                            <div class="flex items-center justify-between p-4 bg-linear-to-br from-blue-50 to-techgap-50 rounded-xl">
                            ...
                            <!-- Views -->
                            <div class="flex items-center justify-between p-4 bg-linear-to-br from-green-50 to-emerald-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                            ...
                            <!-- Likes -->
                            <div class="flex items-center justify-between p-4 bg-linear-to-br from-red-50 to-pink-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                        ...
                        <!-- Comments -->
                        <div class="flex items-center justify-between p-4 bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl">
                            <div class="flex items-center space-x-3">
                                ...
                                @foreach($user->posts()->latest()->take(3)->get() as $post)
                                    <a href="{{ route('posts.show', $post->slug) }}" class="group block p-4 rounded-xl hover:bg-gray-50 transition border border-gray-100 hover:border-techgap-200">
                                        <div class="flex items-start space-x-4">
                                            ...
                                            @else
                                                <div class="w-20 h-20 rounded-lg bg-linear-to-br from-techgap-500 to-techgap-700 flex items-center justify-center text-3xl shrink-0">
                                                    {{ $post->category->icon }}
                                                </div>
                                            @endif
                                            <div class="flex-1 min-w-0">
