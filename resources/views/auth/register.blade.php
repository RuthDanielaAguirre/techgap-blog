            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        ...
                        >
                            <i x-show="!show" class="ph ph-eye text-gray-400 hover:text-gray-600 text-lg"></i>
                            <i x-show="show" class="ph ph-eye-slash text-gray-400 hover:text-gray-600 text-lg"></i>
                        </button>
                    </div>
                    @error('password')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    >
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <i class="ph ph-user-plus ph-bold text-techgap-300 group-hover:text-techgap-200 text-lg"></i>
                        </span>
                        Crear Cuenta
                    </button>
                </div>
