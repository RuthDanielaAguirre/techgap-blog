...
@section('content')
<div class="min-h-screen py-20 bg-gradient-to-b from-white to-techgap-50/40">
    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="text-center mb-20">
            <div class="inline-flex items-center justify-center w-24 h-24 
                        bg-techgap-100 rounded-3xl shadow-md shadow-techgap-900/5 mb-8">
            ...
            <p class="text-lg md:text-xl text-techgap-600 max-w-2xl mx-auto">
                Comparte tu experiencia con la comunidad TechGap
            </p>
        </div>

        <!-- Benefits -->
        <div class="bg-white rounded-3xl shadow-lg shadow-techgap-900/5 border border-techgap-100 p-12 mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="flex items-start space-x-4">
                    <div class="w-10 h-10 bg-{{ $b['icon'] }}-100 rounded-xl flex items-center justify-center">
        ...
        <!-- Form -->
        <div class="bg-white rounded-3xl shadow-lg shadow-techgap-900/5 border border-techgap-100 p-12">
            ...
            <form method="POST" action="{{ route('writer-applications.store') }}" class="space-y-10">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        minlength="100"
                        maxlength="1000"
                        class="w-full px-5 py-4 border border-techgap-200 rounded-2xl 
                               bg-techgap-50/50 focus:ring-2 focus:ring-techgap-500 
                               focus:border-transparent transition text-techgap-900"
                        placeholder="Cuéntanos sobre tu experiencia, qué temas te apasionan..."
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-5 py-3 border border-techgap-200 rounded-2xl 
                               bg-techgap-50/50 focus:ring-2 focus:ring-techgap-500 
                               focus:border-transparent transition text-techgap-900">
                </div>

                <!-- Info -->
                <div class="bg-techgap-50 border border-techgap-200 rounded-2xl p-6">
                ...
                <div class="flex justify-between pt-6 border-t border-techgap-200">
                    <a href="{{ route('profile.show') }}" 
                       class="px-6 py-3 border border-techgap-300 rounded-xl text-techgap-700 hover:bg-techgap-50">
                        Cancelar
                    </a>

                    <button type="submit"
                        class="px-8 py-3 bg-techgap-700 text-white rounded-xl font-semibold 
                               hover:bg-techgap-800 transition shadow-md">
                        Enviar Solicitud
                    </button>
                </div>
